...
function showbox1() {
    ...
    db.ref(boxpath).once('value', e => {
        ...
        var pathReference = storageRef.child('民雄/' + boxvalue['image']);
        console.log(pathReference);
        //pathReference = storageRef.child('message.svg');

        // if(pathReference.getDownloadURL());
        console.log(pathReference.getDownloadURL().i);
        //pathReference = storageRef.child('message.svg');
        //console.log(pathReference.getDownloadURL().i);
            ...
            switch (error.code) {
              case 'storage/object-not-found':
                ...
                pathReference.getDownloadURL().then(function (url) {
                    ...
                    var tr1_td4 = document.createElement('td');
                    tr1_td4.style.cssText = "padding-right:50px;padding-left:50px;";
                    tr1_td4.innerHTML = "<img src=\"" + imgUrl + "\" style=\"height:80px;padding-left:15px;\"/>";
                    console.log(imgUrl);
                    //将列添加到行内
                    // tb_tr1.appendChild(tr1_td1);
                    tb_tr1.appendChild(tr1_td2);
