  ...
  var cvalue;
  function getco2data() {
      var locateCo2 = document.getElementById("locateCO2").value;
      var path = '/processeddata/co2/'+locateCo2;
      console.log(path);
      //read data from firebase
  ...
  function drawco2marker(){
    ...
    marker.bindPopup("<strong>BOXtest</strong><br>CO2濃度:350ppm。").openPopup();
